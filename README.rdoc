...
1. Clone the git repository from the location provided in your email
...
5. Run the applications migrations
6. Identify code to be refactored
7. Create 1 commit(s) with your refactored code
8. Create 1 commit with your notes
9. Push the commits to the github repository
